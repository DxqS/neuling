...
@author: chk01
'''
# from model_variable import number_softmax
# from model_variable import number_cnn
# from model_variable import style_softmax
from model_variable import style_cnn
